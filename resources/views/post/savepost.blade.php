                            ...
                            <form action="{{url('updatepost')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                     <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control" id="name" aria-describedby="emailHelp"  name="name" placeholder="Enter name" value="{{isset($data->name)?$data->name:''}}">
                                    </div>
                                    <div class="col-md-4">
                                        <label for="user_name">User Name</label>
                                        <input type="text" class="form-control" id="user_name" aria-describedby="emailHelp" name="user_name" placeholder="Enter Username" value="{{isset($data->user_name)?$data->user_name:''}}" >
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-4" style="margin-top: 30px"> 
                                                <button id="addEmail" type="button" class="btn btn-primary">Add more</button> 
                                                 <button id="removeEmail" type="button" class="btn btn-warning">Remove last</button>
                                            </div>                                          
                                    ...
                                    <div class="row">
                                         ...
                                         <div class="col-md-4" style="margin-top: 30px"> 
                                            ...
                                            <button id="removeContact" type="button" class="btn btn-warning">Remove last</button>
                                        </div>
